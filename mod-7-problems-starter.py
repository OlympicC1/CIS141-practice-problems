...
# Defining the function called level_up w/parameter
def level_up(experience):
# Check if the experience is between 0 through 99
    if experience >= 0 and experience <= 99:
        return 1 # This is going to be level 1
# Check if the experience is between 100 through 199
    elif experience >= 100 and experience <=199:
        return 2 # This level 2
# Check if experience is 200 or greater
    elif experience >= 200:
        return 3 # Level 3
# Case for negative experience points
    else:
        return 0 # This should return negative experience
# Functions should operate in order for output
print(level_up(50)) # 1
print(level_up(75)) # 2
print(level_up(100)) # 3
print(level_up(-10)) # 4
'''
'''
